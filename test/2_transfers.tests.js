...
describe("Transfer tests", function () {
  ...
  context("Balance checks", function () {
    it("Customer has a tokens because it has ETH", async function () {
      ...
      console.log(await ethers.provider.getBalance(fAddr.address))
      console.log(await ethers.provider.getBalance(aAddr.address))
      console.log(await ethers.provider.getBalance(nAddr.address))
